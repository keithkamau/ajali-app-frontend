...
import { fetchIncidents, deleteIncident, clearSuccess } from '../redux/slices/incidentSlice';

export const DashboardPage = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { items, loading, error, success } = useSelector((state) => state.incidents);
  ...
  const userIncidents = items.filter(item => item.user_id === user?.id || !item.user_id);
      ...
      <div className="incident-list">
        {loading ? (
          ...
          <div className="empty-state">
            <p className="body-text text-muted">You haven't reported any incidents yet</p>
            ...
            >
              ...
              <div className="incident-card-footer">
                <span className="incident-card-meta">
                  {incident.created_at ? new Date(incident.created_at).toLocaleDateString() : 'Recently'}
